...
$stmt = $cov->prepare("UPDATE tbl_contributions SET contribution=?, special_savings=? WHERE membersid=? AND periodid=?");
$stmt->bind_param("ddii", $amount, $special, $memberid, $periodid);
if ($stmt->execute()) {
