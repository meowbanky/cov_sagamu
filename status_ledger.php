...
function getStatus() {		
		//alert("hi");
			...
			if (document.getElementById('PeriodId1').value == "na"){
		...
		var strURL="getStatus_ledger.php?periodid="+period1;
		var req = getXMLHTTP();
                        ...
                        <form action="<?php echo $editFormAction; ?>" method="POST" name="eduEntry" onSubmit="return(validate()); ">
                         ...
                         <table width="66%" align="center" cellpadding="4" cellspacing="0">
                           ...
                           <td colspan="2" height="1"><img src="skills_files/spacer.gif" width="1" height="1"></td>
                             ...
                             <tr valign="top" align="left">
                               <td width="37%" height="35" align="right" valign="middle" class="greyBgd">Period:</td>
                               <td width="63%" align="left" valign="middle" class="greyBgd"><div id="div">
                                 <select name="PeriodId1" id="PeriodId1" onChange="getStatus()">
...
?>
                             ...
                             <tr valign="top" align="center">
                               <td colspan="2" valign="middle" height="10"><input name="Search" type="button" class="formbutton" id="Submit" value="Search" onClick="getStatus()"></td>
                             </tr>
                             <tr valign="top" align="center">
