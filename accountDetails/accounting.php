...
<?php
include('session_generator.php');
//session_start();
$prefix = "COV";//substr($_SESSION['companyName'],0,3);
...
mysql_select_db($database_cov, $cov);
$query_Type = "SELECT tbl_account_type.type,tbl_account_type.type_id FROM tbl_account_type order by type_id asc";
$Type = mysql_query($query_Type, $cov) or die(mysql_error());
...
<table class="innerWhiteBox" width="96%" border="0" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td align="" class="yelloBoxCell"><img src="education_files/spacer.gif" width="1" border="0" height="8"><div id="session"><?PHP echo $_SESSION['SESS_INVOICE'] ?></div></td>
    <td class="yelloBoxCell" width="100%" align=""><a href="http://careers.mtnonline.com/myapplications.asp"></a> </td>
  </tr>
...
<form method="POST" name="eduEntry" onSubmit="MM_validateForm('txtBankName','','R','txtBankAccountNo','','R','txtbankcode','','R','txtAmount','','R','txNarration','','R');return document.MM_returnValue">
                       <fieldset>
                       ...
                       <table width="97%" align="center" cellpadding="4" cellspacing="0">
                         <tbody><tr valign="top" align="left">
                           ...
                           <tr valign="top" align="left">
                             <td width="31%" height="35" align="right" valign="middle" class="greyBgd">Transaction Type</td>
                             <td width="69%" align="left" valign="middle" class="greyBgd"><select name="transact_type" required="required" class="form-group" id="transact_type"><option value="">Select Type</option>
        <?php
do {  
?>
                                 <option value="<?php echo $row_Type['type_id']?>"><?php echo $row_Type['type']?></option>
      <?php
  ...
  if($rows > 0) {
    ...
    ?></select></td>
                             <td width="69%" rowspan="8" align="left" valign="top" class="greyBgd">
                               <div id="hide"><iframe id="opatdetails" frameborder="0" src="" width=0 height=0 style="overflow-style:auto"></iframe></div>
                               <p><br>
                               </p>
                               <p>&nbsp; </p></td>
                           ...
                           <tr valign="top" align="left">
                             <td class="greyBgd" valign="middle" align="right" height="35">&nbsp;<label for="post_account">Post to Account:</label></td>
                             <td class="greyBgd" valign="middle" align="left">
                               <input name="post_account" type="text" required="required" id="post_account" autocomplete="on"></td>
                           </tr>
                           <tr valign="top" align="left">
                             <td class="greyBgd" valign="middle" align="right" height="35"><label for="transact_date">Date:</label></td>
                             <td class="greyBgd" valign="middle" align="left"><input name="transact_date" type="date" required="required" id="transact_date"></td>
                           </tr>
                           <tr valign="top" align="left">
                             <td class="greyBgd" valign="middle" align="right" height="35">Period:</td>
                             <td class="greyBgd" valign="middle" align="left">&nbsp;<select name="period" required="required" id="period" >
...
?>
                           ...
                           <tr valign="top" align="left">
                             <td class="greyBgd" valign="middle" align="right" height="35">Details:</td>
                             <td class="greyBgd" valign="middle" align="left"><input name="details" type="text" required="required" id="details"></td>
                           </tr>
                           <tr valign="top" align="left">
                             <td class="greyBgd" valign="middle" align="right" height="35">Amount:</td>
                             <td class="greyBgd" valign="middle" align="left"><input name="number" type="number" required="required" id="amount"></td>
                           </tr>
                           <tr valign="top" align="left">
                           ...
                           <div class="suggestionsBox" id="suggestions" style="display: none;" >
                             <img src="upArrow.png" style="position: relative;  left: 30px;" alt="upArrow" />
                         ...
                         <tr valign="top" align="left">
                           <td colspan="3" valign="middle" align="center" height="10">
                               <input type="submit" id="submit" style="cursor:pointer" class="formbutton" value="Save"/>
                            <!-- <input name="Submit" onClick="location.href='editAccountNo.php'" class="formbutton" value="Edit Account No." type="button"></t"d>
                         --></tr>
                         <tr valign="top" align="left">
                           <td colspan="3" height="3"><img src="education_files/spacer.gif" width="1" height="1"> <p id="returnmessage"></p><p id="mess1" align="center"></p></td>
                         </tr>
                       </tbody></table>
                       </fieldset>
...
$("#transact_type").change(function(){
    
    $.post("session_generator.php", {
    
}, function(data,status) {
	//alert(data+' '+ status)
        $("#session").html('');
$("#session").append(data); // Append returned message to message paragraph.
...
$("#loadSession").load('saved.php');
$("#submit").click(function() {
$("#submit").attr('disabled',true);
$("#submit").val('Saving...');
var transact_type = $("#transact_type").val();
var post_account = $("#post_account").val();
...
$("#submit").val('Save');
}else if (post_account == ''){
	$("#post_account").focus();
	$("#submit").attr('disabled',false);
$("#submit").val('Save');
}else if (transact_date == ''){
    $("#transact_date").focus();
	$("#submit").attr('disabled',false);
    $("#submit").val('Save');
}else if (period == ''){
...
//$("#MessageIndexForm")[0].reset(); // To reset form fields on success.
 ...
 var options = {};   
$("#mess1").hide();
document.getElementById("mess1").style.backgroundColor="#FE8282";
$("#mess1").attr('align',"center")  ; 
    //alert($("#mess1").attr("align"));
document.getElementById("mess1").innerHTML="Transaction Saved Successfully";
    
document.getElementById("mess1").style.visibility="visible";
//$("#mess1").show("blind",options,1000);
$("#mess1").show("slow");
$("#details").val('') ;
$("#amount").val('') ;
    setTimeout(function(){ $("#mess1").hide(); }, 3000);
$("#loadSession").load('saved.php');
