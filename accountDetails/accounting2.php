...
mysql_select_db($database_cov, $cov);
$query_Type = "SELECT tbl_account_type.type FROM tbl_account_type order by type_id asc";
...
<div class="col-lg-4"></div>
    <div class="col-lg-4"><form> <div class="form-group"><label class="form-group">Transaction Type</label><select class="form-group"><option value="">Select Type</option>
        <?php
do {  
?>
  ...
  if($rows > 0) {
    ...
    <div class="form-group">
          <label for="post">Post to:</label>
          <input type="post" class="form-control" id="post" placeholder="Account to Post">
           </div>
    </form></div>
  </div>
</div>
