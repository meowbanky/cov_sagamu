                    ...
                    <tbody>
                      <tr>
                        <td class="sidenavtxt" align=""><em>
                            <font size="1" face="Verdana, Arial, Helvetica, sans-serif">Welcome,</font>
                          </em>
                          <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><span><?php if(isset($_SESSION['FirstName'])) { echo ($_SESSION['FirstName']); } ?><br>
                              <img src="resource/spacer.gif" alt="" width="1" height="8" border="0"><img src="resource/arrow_bullets2.gif" alt="" border="0"> <a href="index.php">Logout</a> </span></font>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                              ...
                              <tbody>
                                <tr>
                                  <td valign="top">
                                    ...
                                    <br>
                                    <fieldset>
                                      <legend class="contentHeader1">Overdue Loan</legend>
                                      <script language="JavaScript" type="text/JavaScript">
                                        <!--
function GP_popupConfirmMsg(msg) { //v1.0
  document.MM_returnValue = confirm(msg);
                                        ...
                                        <tbody>
                                          ...
                                          <tr valign="top" align="right">
                                            ...
                                            <td class="content" height="1"><a>
                                                <form name="period2">
                                                  <select name="PeriodId2" id="PeriodId2" onChange="getOverdueLoan(document.forms['period2'].PeriodId2.value)">
