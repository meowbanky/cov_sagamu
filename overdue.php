...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "eduEntry")) {
  ...
  $insertSQL = sprintf(
    "INSERT INTO tbl_loan (memberid, periodid, loanamount) VALUES (%s, %s, %s)",
  ...
  $insertSQLBankSchedule = sprintf(
    "INSERT INTO tbl_bank_schedule (memberid, name, periodid, loanamount) VALUES (%s, %s, %s, %s)",
    GetSQLValueString($cov, $_POST['txtCoopid'], "text"),
...
//$check_Period = mysql_query($query_check_Period, $cov) or die(mysqli_error($cov));
...
<head>
    ...
    function getOverdueLoan(id) {


        document.getElementById('overdue_display').style.display = "block";
        //var id = document.getElementById('periodset').value;
        var strURL = "getoverdue.php?month=" + id;
        var req = getXMLHTTP();
        ...
        if (req) {
            ...
            req.onreadystatechange = function() {
                if (req.readyState == 4) {
                    // only if "OK"
                    if (req.status == 200) {
                        document.getElementById('overdue_display').innerHTML = req.responseText;
                    } else {
                        alert("There was a problem while using XMLHTTP:\n" + req.statusText);
                    }
                }
                ...
                <td class="centerAligned" valign="top" height="100">
                    ...
                    <table width="750" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="4" rowspan="4" align="center"><img name="top_r2_c1"
                                        src="resource/spacer.gif" alt="" width="1" border="0" height="1"><img
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2" class="breadcrumbs" valign="bottom" height="20"><a
                                        href="http://careers.mtnonline.com/index.asp"> </a></td>
                                ...
                                <td class="Content" valign="top" width="180">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="sidenavtxt" align=""><em>
                                                    ...
                                                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                                                        <span><?php if(isset($_SESSION['FirstName'])) { echo ($_SESSION['FirstName']); } ?><br>
                                                            <img src="resource/spacer.gif" alt="" width="1" height="8"
                                                                border="0"><img src="resource/arrow_bullets2.gif" alt=""
                                                                border="0"> <a href="index.php">Logout</a> </span>
                                                    </font>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="innerWhiteBox" width="96%" border="0" cellpadding="4" cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align=""><img src="skills_files/spacer.gif" alt="" width="1"
                                                        height="8" border="0"><img src="skills_files/arrow_bullets2.gif"
                                                        alt="" border="0"></td>
                                                <td width="100%" align="" class="sidenavtxt"><a
                                                        href="registration.php">Registration</a></td>
                                            </tr>
                                            <tr>
                                                <td align=""><img src="skills_files/spacer.gif" alt="" width="1"
                                                        height="8" border="0"><img src="skills_files/arrow_bullets2.gif"
                                                        alt="" border="0"></td>
                                                <td class="sidenavtxt" align=""><a href="dashboard.php">DashBoard</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align=""><img src="skills_files/spacer.gif" alt="" width="1"
                                                        height="8" border="0"><img src="skills_files/arrow_bullets2.gif"
                                                        alt="" border="0"></td>
                                                <td class="sidenavtxt" align=""><a href="process2.php">Process
                                                        Transaction</a></td>
                                            </tr>
                                            <tr>
                                                <td align=""><img src="skills_files/spacer.gif" alt="" width="1"
                                                        height="8" border="0"><img src="skills_files/arrow_bullets2.gif"
                                                        alt="" border="0"></td>
                                                <td class="sidenavtxt" align=""><a href="editContributions.php">Edit
                                                        Contribution</a></td>
                                            </tr>
                                            <tr>
                                                <td align=""><img src="skills_files/spacer.gif" alt="" width="1"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="top">
                                                                        ...
                                                                        <br>
                                                                        <fieldset>
                                                                            <legend class="contentHeader1">Overdue Loan
                                                                            </legend>
                                                                            <script language="JavaScript"
...
//-->
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr valign="top" align="right">
                                                                                        <td class="content" align="left"
                                                                                            height="1"></td>
                                                                                        <td class="content" height="1">
                                                                                            <a>
                                                                                                <form name="period2">
                                                                                                    <select
                                                                                                        name="PeriodId2"
                                                                                                        id="PeriodId2"
                                                                                                        onChange="getOverdueLoan(document.forms['period2'].PeriodId2.value)">
                                                                                                        <option
                                                                                                            value="-1">
                                                                                                            Select
                                                                                                            Period
                                                    ...
                                                    ?>
                                                                                                        <option
                                                                                                            value="<?php echo $row_Period['Periodid'] ?>">
                                                                                                            <?php echo $row_Period['PayrollPeriod'] ?>
                                                                                                        </option>
                                                                                                        <?php
