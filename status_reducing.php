...
function getStatus(id) {		
		...
		if (document.getElementById('txtCoopid').value.trim() == ""){
			...
			}else if (document.getElementById('PeriodId1').value == "na"){
			alert("Please Select Period to get Status");
			document.getElementById('PeriodId1').focus();
				}else{
		document.getElementById('status_old').style.display="none"; 
		var period1 = document.getElementById('PeriodId1').value;
		//var period2 = document.getElementById('PeriodId2').value;
		var strURL="getStatus_reducing.php?id="+id+"&period1="+period1;
		var req = getXMLHTTP();
                             ...
                             <tr valign="top" align="left">
                               <td class="greyBgd" valign="middle" align="right" height="35">Period:</td>
                                 <td class="greyBgd" valign="middle" align="left"><div id="div">
                                   <select name="PeriodId1" id="PeriodId1">
...
?>
                             ...
                             <tr valign="top" align="center">
                               <td colspan="2" valign="middle" height="10"><input name="Search" type="button" class="formbutton" id="Submit" value="Search" onClick="getStatus(document.forms['eduEntry'].txtCoopid.value)"></td>
                             </tr>
                             <tr valign="top" align="center">
