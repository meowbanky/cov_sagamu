...
<script type="text/javascript" language="javascript">
		...
		function jumptoPassport(oForm){
	
	window.location="image_upload/upload.php?memberid="+oForm.value;
	
	
	} 	
function jumptoURL(oForm){
	
	window.location="edit_registration.php?memberid="+oForm.value;
...
function onSelectedSearch() {
                ...
                var url="Search.php?SearchMRN="+mrn;
...
<tbody>
<tr>
  <td><img src="resource/spacer.gif" alt="" border="0"></td>
</tr>
<tr>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <img src="images/SearchPatient.gif" width="350" height="30">
    ...
    <td>Your update was successful</td>
          ...
          <form  method="POST" name="eduEntry" onSubmit="return(validate()); ">
            ...
            <div id="patoc"  name="patoc" style="display: block; margin-left: 0em;">
              <fieldset>
                <legend class="contentHeader1">Search Existing Member's Record</legend>
                <table width="96%" align="center" cellpadding="4" cellspacing="0">
                  <tbody>
                    <tr valign="top">
                      <td width="36%" height="35" align="right" valign="middle" class="greyBgd"> Enter Search Criteria e.g. First Name,Last Name, Telephone No, Staff No: </td>
