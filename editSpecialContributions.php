...
mysqli_select_db($cov, $database_cov);
$query_members = "SELECT CONCAT(tbl_personalinfo.Lname,' , ',tbl_personalinfo.Fname,' ',(ifnull(tbl_personalinfo.Mname,' ')),' - ', tbl_personalinfo.patientid) AS `name`, tbl_personalinfo.patientid FROM tbl_personalinfo LEFT JOIN tbl_specialcontributions ON tbl_specialcontributions.membersid = tbl_personalinfo.patientid where tbl_personalinfo.status = 'Active' ORDER BY tbl_personalinfo.patientid
";
...
if (isset($_GET['deleteid'])){
  ...
  $delete_contributions = sprintf("DELETE FROM tbl_specialcontributions WHERE contriId = %s",
...
function getcontribution(id) {		
		...
		var strURL="getContributionsSpecial.php?id="+id;
		var req = getXMLHTTP();
	...
	function getcontributionList() {		
		...
		var strURL="getContributionSpecialList.php?periodid="+periodid;
		var req = getXMLHTTP();
	...
	function saveContributions() {		
		...
		//alert(contributions);
		var strURL="saveContributionsSpecial.php?id="+txtCoopid+"&periodset="+periodset+"&Amount="+Amount;
...
$Period_session = mysqli_query($cov,$query_Period_session) or die(mysql_error());
                     ...
                     <tr>
                       <td valign="top"><form method="POST" name="eduEntry" onSubmit="MM_validateForm('txtBankName','','R','txtBankAccountNo','','R','txtbankcode','','R','txtAmount','','R','txNarration','','R');return document.MM_returnValue">
                         <fieldset>
						   ...
						   <legend class="contentHeader1">Edit Special Contributions</legend>
...
?>
 ...
 <img src="images/pageloading.gif" class="area">Please wait...
                         ...
                         -->
                                    <span class="highheader"><a href="contributionSpecialList.php">Contribution List</a></span></tr>
                               <tr valign="top" align="left">
