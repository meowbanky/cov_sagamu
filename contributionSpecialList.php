...
<title><?php echo $row_title['value']; ?> -  Loan Contribution Compare</title>
           ...
           <tbody><tr>
             <td class="toplinks2" valign="top"><div align="justify">
                 <table class="Content" width="100%" border="0" cellpadding="4" cellspacing="0">
                   <tbody><tr>
                     <td valign="top"><form action="" method="POST" name="eduEntry" onSubmit="return(validate()); ">
                      ...
                      <fieldset>
                         <legend class="contentHeader1"> Special Contribution List<a name="top"></a></legend>
                         
                     
                         <table width="100%" border="0" class="contentHeader1">
                           <tr>
                             <td width="41%" align="right">Select Period</td>
                             <td width="59%"><select name="PeriodId" id="PeriodId" onChange="getContribution()" >
