...
$insertSQL_pastor = sprintf("INSERT INTO tbl_pastor (patientId, NamePastor, PhonePastor, Name_Address_Church) VALUES (%s, %s, %s, %s)",
					   GetSQLValueString($MRN, "text"),
					   GetSQLValueString($_POST['NamePastor'], "text"),
                       GetSQLValueString($_POST['PhonePastor'], "text"),
					    GetSQLValueString($_POST['Name_Address_Church'], "text"));
						mysql_select_db($database_hms, $hms);
  $Result2 = mysql_query($insertSQL_pastor, $hms) or die(mysql_error());
