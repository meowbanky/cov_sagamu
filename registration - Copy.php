...
//	mysql_select_db($database_cov, $cov);
// 	$Result_1 = mysql_query($insetTogetMrn, $cov) or die(mysql_error());
//	$MRN = mysql_insert_id();
//	$getDate = date("y/m/");
//	$MRN = $getDate.$MRN;
...
if (isset($_POST['status'])){
  ...
  $insertSQL = sprintf("INSERT INTO tbl_personalinfo (sfxname, Fname, Mname, Lname, gender, DOB, Address, Address2, City, `State`, MobilePhone, EmailAddress,DateOfReg,status,ordered_id) VALUES (%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,NOW(),%s,%s)",
  ...
  $insertSQL_login = sprintf("INSERT INTO tblusers (UserID, firstname, middlename, lastname, Username,UPassword,CPassword,PlainPassword,dateofRegistration) VALUES (%s, %s, %s, %s,%s, password(%s), password(%s), %s,now())",
                       GetSQLValueString($id, "text"),
					   GetSQLValueString($_POST['Fname'], "text"),
                       GetSQLValueString($_POST['Mname'], "text"),
                       GetSQLValueString($_POST['Lname'], "text"),
					   ...
					   GetSQLValueString($_POST['passwordGen'], "text"));
						mysql_select_db($database_cov, $cov);
  $Result3 = mysql_query($insertSQL_login, $cov) or die(mysql_error());
...
$insertSQL_NOK = sprintf("INSERT INTO tbl_nok (memberid, NOkName, NOKRelationship, NOKPhone, NOKAddress) VALUES (%s, %s, %s, %s,%s)",
					   ...
					   GetSQLValueString($_POST['NOKPhone'], "text"),
						...
						mysql_select_db($database_cov, $cov);
  $Result3 = mysql_query($insertSQL_NOK, $cov) or die(mysql_error());
  

mysql_select_db($database_cov, $cov);
$query_settings_contri = "SELECT tbl_settings.contribution FROM tbl_settings";
$settings_contri = mysql_query($query_settings_contri, $cov) or die(mysql_error());
$row_settings_contri = mysql_fetch_assoc($settings_contri);
$totalRows_settings_contri = mysql_num_rows($settings_contri);
...
//						mysql_select_db($database_cov, $cov);
//  $Result34 = mysql_query($insertSQL_contribution, $cov) or die(mysql_error());
...
$tribe = mysql_query($query_tribe, $cov) or die(mysql_error());
...
$nokRelationship = mysql_query($query_nokRelationship, $cov) or die(mysql_error());
...
$state2 = mysql_query($query_state2, $cov) or die(mysql_error());
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="500" border="0" cellpadding="0" cellspacing="0">
    ...
    <div align="justify">
      <table class="Content" width="100%" border="0" cellpadding="4" cellspacing="0">
        ...
        <tr>
          <td valign="top">
          <input name="equal" id = "equal" type="hidden" value="="><input name="memberid" id = "memberid" type="hidden" value="<?php echo $_GET['id'];?>"><span class="homeContentSmaller">
  ...
  <tbody><tr>
    <td>Record Inserted Successfully</td>
             ...
             <?php if (isset($_GET['id'])){?> <script language="javascript" type="text/javascript">sendsms();</script><?php } ?>
              <br>
          </span>
...
//document.getElementById("new_mrn").focus();
                    ...
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><input name="Address" type="text" class="innerBox" id="Address"></td>
                    </tr>
                    <tr valign="middle" align="left">
                      <td class="greyBgd" width="43%" align="right" height="35">Address 2: </td>
                      <td class="greyBgd" width="57%" align="left"><input name="Address2" type="text" class="innerBox" id="Address2"></td>
                    </tr>
                    <tr valign="middle" align="left">
...
do {  
?>
                        <option value="<?php echo $row_state2['State']?>"<?php if (!(strcmp("Ogun State", $row_state2['State']))) {echo "selected=\"selected\"";} ?>><?php echo $row_state2['State']?></option>
                        <?php
...
?>
                  ...
                  <tr valign="middle" align="left">
                    ...
                    <td class="greyBgd" width="57%" align="left"><input name="MobilePhone" type="text" class="innerBox" id="MobilePhone"></td>
                  </tr>
                  <tr valign="middle" align="left">
                    <td class="greyBgd" width="43%" align="right" height="35">E-mail Address: </td>
                    <td class="greyBgd" width="57%" align="left"><input name="EmailAddress" type="text" class="innerBox" id="EmailAddress"></td>
                  </tr>
                  <tr valign="middle" align="left">
...
do {  
?>
                                <option value="<?php echo $row_nokRelationship['relationship']?>"><?php echo $row_nokRelationship['relationship']?></option>
                                <?php
...
?>
                      ...
                      <fieldset>
                      <br>
                      <legend class="contentHeader1">Generate User's Password</legend>
<table width="96%" align="center" cellpadding="4" cellspacing="0" class="greyBgd">
  <tr>
    <th scope="col"><span class="greyBgd">Generate Password</span></th>
    <th scope="col"><span class="greyBgd">
      <input name="passwordGen" type="text" class="innerBox" id="passwordGen">
    </span></th>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="center"><input name="Submit2" class="formbutton" value="Generate" type="button" onClick="generate()"></td>
  </tr>
</table>
                      </fieldset>
                      <p>
...
if ((isset($_POST["Submit"])) && ($_POST["Submit"] == "Save")) {
mysql_free_result($settings_contri);}
?>
