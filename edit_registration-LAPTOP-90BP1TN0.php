...
// 	$Result_1 = mysql_query($insetTogetMrn, $hms) or die(mysql_error());
//	$MRN = mysql_insert_id();
//	$getDate = date("y/m/");
//	$MRN = $getDate.$MRN;
...
if (isset($_POST['status'])){
  ...
  $insertSQL = sprintf("UPDATE tbl_personalinfo SET sfxname = %s, Fname = %s, Mname = %s, 
						 ...
						 MobilePhone = %s,EmailAddress = %s, `status` = '".$statusCheck ."' WHERE patientid = %s",
					   ...
					   GetSQLValueString($_POST['initial_mrn'], "text"));
 ...
 $insertSQL_NOK = sprintf("UPDATE tbl_nok SET patientId = %s , NOkName = %s, NOKRelationship = %s, NOKPhone = %s, NOKAddress = %s WHERE patientid = %s",
					   ...
					   GetSQLValueString($_POST['initial_mrn'], "text"));
						mysql_select_db($database_hms, $hms);
  $Result3 = mysql_query($insertSQL_NOK, $hms) or die(mysql_error());
...
$nokRelationship = mysql_query($query_nokRelationship, $hms) or die(mysql_error());
$row_nokRelationship = mysql_fetch_assoc($nokRelationship);
$totalRows_nokRelationship = mysql_num_rows($nokRelationship);

mysql_select_db($database_hms, $hms);
$query_state2 = "SELECT * FROM state_nigeria";
$state2 = mysql_query($query_state2, $hms) or die(mysql_error());
$row_state2 = mysql_fetch_assoc($state2);
$totalRows_state2 = mysql_num_rows($state2);

$col_editRecords = "-1";
if (isset($_GET['patientid'])) {
  $col_editRecords = $_GET['patientid'];
}
mysql_select_db($database_hms, $hms);
$query_editRecords = sprintf("SELECT tbl_personalinfo.patientid, tbl_personalinfo.sfxname, tbl_personalinfo.Fname, tbl_personalinfo.Mname, tbl_personalinfo.Lname, tbl_personalinfo.MaidenName, tbl_personalinfo.Mothersname, tbl_personalinfo.gender, tbl_personalinfo.bloodGroup, tbl_personalinfo.Status, tbl_personalinfo.DOB, tbl_personalinfo.Address, tbl_personalinfo.Address2, tbl_personalinfo.State, tbl_personalinfo.City, tbl_personalinfo.countryOrigin, tbl_personalinfo.StateOfOrigin, tbl_personalinfo.Tribe, tbl_personalinfo.EducationLevel, tbl_personalinfo.Occupation, tbl_personalinfo.Religion, tbl_personalinfo.MobilePhone, tbl_personalinfo.EmailAddress, tbl_personalinfo.DateOfReg, tbl_nok.NOkName, tbl_nok.NOKRelationship, tbl_nok.NOKPhone, tbl_nok.NOKAddress FROM tbl_personalinfo left JOIN tbl_nok ON tbl_nok.patientId = tbl_personalinfo.patientid WHERE tbl_personalinfo.patientid = %s", GetSQLValueString($col_editRecords, "text"));
$editRecords = mysql_query($query_editRecords, $hms) or die(mysql_error());
$row_editRecords = mysql_fetch_assoc($editRecords);
$totalRows_editRecords = mysql_num_rows($editRecords);
...
<title>MHWUN, OOUTH - Edit Member's Registration</title>
    ...
    <table width="750" border="0" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="3" rowspan="4" align="center"><img src="images/mhwun_logo_web.jpg" width="499" height="95"><img name="top_r4_c4" src="personal_files/spacer.gif" alt="" width="1" border="0" height="1"></td>
          <td>&nbsp;</td>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <img src="personal_files/editPatientInfo.gif" width="350" height="30">
                ...
                <table width="96%" align="center" cellpadding="4" cellspacing="0">
                  <tbody>
                    ...
                    <tr valign="middle" align="left">
                      <td class="greyBgd" align="right" height="35">Staff No.:<font color="red">*</font></td>
                      <td class="greyBgd" align="left"><label for="new_mrn"></label>
                        <input name="new_mrn"  type="text" class="innerBox" id="new_mrn" onBlur="Javascript:onSelectedSearchMRN(this.value)" value="<?php echo $row_editRecords['patientid']; ?>" readonly>
                        <input name="initial_mrn" type="hidden" id="initial_mrn" value="<?php echo $row_editRecords['patientid']; ?>"></p>
                       
                        <div id="UploadSearchResult"></div>
                        </td>
                    </tr>
                   <tr>
...
//document.getElementById("new_mrn").focus();
                    ...
                    <td class="greyBgd"><select name="sfxname" class="innerBox" style="width:145px">
                      <option value="na" <?php if (!(strcmp("na", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>-Select-</option>
                      <option value="Mr" <?php if (!(strcmp("Mr", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Mr</option>
                      <option value="Miss" <?php if (!(strcmp("Miss", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Miss</option>
                      <option value="Mrs" <?php if (!(strcmp("Mrs", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Mrs</option>
                      <option value="Dr" <?php if (!(strcmp("Dr", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Dr</option>
                      <option value="Baby" <?php if (!(strcmp("Baby", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Baby</option>
                      <option value="Master" <?php if (!(strcmp("Master", $row_editRecords['sfxname']))) {echo "selected=\"selected\"";} ?>>Master</option>
                    </select>
                    </td>
                    ...
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><input name="Fname" type="text" class="innerBox" id="Fname" value="<?php echo $row_editRecords['Fname']; ?>">
                        *</td>
                    </tr>
                    <tr valign="middle" align="left">
                      <td class="greyBgd" width="43%" align="right" height="35">Middle Name: </td>
                      <td class="greyBgd" width="57%" align="left"><input name="Mname" type="text" class="innerBox" id="Mname" value="<?php echo $row_editRecords['Mname']; ?>"></td>
                    </tr>
                    <tr valign="middle" align="left">
                      <td class="greyBgd" width="43%" align="right" height="35">Last Name:<font color="red">*</font></td>
                      <td class="greyBgd" width="57%" align="left"><input name="Lname" type="text" class="innerBox" id="Lname" value="<?php echo $row_editRecords['Lname']; ?>">
                        *</td>
                    </tr>
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><p>
                        <label>
                          <input  type="radio" name="gender" value="Male" <?php if($row_editRecords['gender']=="Male"){echo "checked=checked";} ?>>
                          Male</label>
                        <label>
                          <input  type="radio" name="gender" value="Female" <?php if($row_editRecords['gender']=="Female"){echo "checked=checked";} ?>>
                          Female</label>
                        <br>
                        </p></td>
                    </tr>
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><input name="DOB" type="text" class="innerBox" id="DOB" value="<?php echo $row_editRecords['DOB']; ?>" readonly>
                    ...
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><input name="Address" type="text" class="innerBox" id="Address" value="<?php echo $row_editRecords['Address']; ?>"></td>
                    </tr>
                    <tr valign="middle" align="left">
                      <td class="greyBgd" width="43%" align="right" height="35">Address 2: </td>
                      <td class="greyBgd" width="57%" align="left"><input name="Address2" type="text" class="innerBox" id="Address2" value="<?php echo $row_editRecords['Address2']; ?>"></td>
                    </tr>
                    <tr valign="middle" align="left">
                      <td class="greyBgd" width="43%" align="right" height="35">City:<font color="red">*</font></td>
                      <td class="greyBgd" width="57%" align="left"><input name="City" type="text" class="innerBox" id="City" value="<?php echo $row_editRecords['City']; ?>"></td>
                    </tr>
                    <tr valign="middle" align="left">
...
do {  
?>
                        <option value="<?php echo $row_state2['State']?>" <?php if (!(strcmp($row_state2['State'], $row_editRecords['State']))) {echo "selected=\"selected\"";} ?>><?php echo $row_state2['State']?></option>
                        <?php
...
?>
                  ...
                  <tr valign="middle" align="left">
                    ...
                    <td class="greyBgd" width="57%" align="left"><input name="MobilePhone" type="text" class="innerBox" id="MobilePhone" value="<?php echo $row_editRecords['MobilePhone']; ?>"></td>
                  </tr>
                  <tr valign="middle" align="left">
                    <td class="greyBgd" width="43%" align="right" height="35">E-mail Address: </td>
                    <td class="greyBgd" width="57%" align="left"><input name="EmailAddress" type="text" class="innerBox" id="EmailAddress" value="<?php echo $row_editRecords['EmailAddress']; ?>"></td>
                  </tr>
                  <tr valign="middle" align="left">
                    <td class="greyBgd" align="right" height="35">Status</td>
                    <td class="greyBgd" align="left"><input <?php if (!(strcmp($row_editRecords['Status'],"Active"))) {echo "checked=\"checked\"";} ?> type="checkbox" name="status" id="status">
                    Active
                        ...
                        <table width="96%" align="center" cellpadding="4" cellspacing="0">
                          <tbody>
                            <tr valign="top">
                              ...
                              <td class="greyBgd" valign="middle" width="64%"><input name="NOkName" type="text" class="innerBox" id="NOkName" value="<?php echo $row_editRecords['NOkName']; ?>"></td>
                            </tr>
                            <tr valign="top">
                              <td height="35" align="right" valign="middle" class="greyBgd"> Relationship to Patient:<font color="red">*</font></td>
                              <td class="greyBgd" valign="middle"><select name="NOKRelationship" class="innerBox" id="NOKRelationship" title="<?php echo $row_editRecords['NOKRelationship']; ?>">
                                <option selected="selected" value="" <?php if (!(strcmp("", "Parent"))) {echo "selected=\"selected\"";} ?>>Select ...</option>
                                <?php
do {  
?>
                                <option value="<?php echo $row_nokRelationship['relationship']?>"<?php if (!(strcmp($row_nokRelationship['relationship'], $row_editRecords['NOKRelationship']))) {echo "selected=\"selected\"";} ?>><?php echo $row_nokRelationship['relationship']?></option>
                                <?php
} while ($row_nokRelationship = mysql_fetch_assoc($nokRelationship));
  $rows = mysql_num_rows($nokRelationship);
  if($rows > 0) {
...
?>
                            ...
                            <tr valign="top">
                              ...
                              <td class="greyBgd" valign="middle"><input name="NOKPhone" type="text" class="innerBox" id="NOKPhone" value="<?php echo $row_editRecords['NOKPhone']; ?>"></td>
                            </tr>
                            <tr valign="top">
                              <td height="35" align="right" valign="middle" class="greyBgd"> Next of Kin Address:<font color="red">*</font></td>
                              <td class="greyBgd" valign="middle"><input name="NOKAddress" type="text" class="innerBox" id="NOKAddress" value="<?php echo $row_editRecords['NOKAddress']; ?>">
                      ...
                      </p><?php if ((isset($_GET['success'])) && (($_GET['success'])== "ok")){  ?>
                      <script language="javascript"> alert("Record Updated Successfully"); </script>
