...
if ((isset($_POST["Submit"])) && ($_POST["Submit"] == "Save")) {
  ...
  $insertSQL = sprintf("INSERT INTO tbl_personalinfo (patientid,sfxname, Fname, Mname, Lname, MaidenName, Mothersname, gender, bloodGroup, MStatus, DOB, Address, Address2, City, `State`, countryOrigin, StateOfOrigin, Tribe, EducationLevel, Occupation, Religion, MobilePhone, EmailAddress,DateOfReg) VALUES (%s,%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,NOW())",
                       GetSQLValueString($MRN, "text"),
					   GetSQLValueString($_POST['sfxname'], "text"),
                       GetSQLValueString($_POST['Fname'], "text"),
                       GetSQLValueString($_POST['Mname'], "text"),
                       GetSQLValueString($_POST['Lname'], "text"),
                       GetSQLValueString($_POST['MaidenName'], "text"),
                       GetSQLValueString($_POST['Mothersname'], "text"),
                       ...
                       GetSQLValueString($_POST['countryOrigin'], "text"),
                       GetSQLValueString($_POST['StateOfOrigin'], "text"),
                       GetSQLValueString($_POST['Tribe'], "text"),
...
$insertGoTo = "schedule.php?mrn=".$MRN;
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_hms, $hms);
$query_country = "SELECT countries.Country FROM countries ORDER BY countries.Country asc";
...
<title>MHWUN - Patient Registration DashBoard</title>
...
function onSelectedSearchMRN(searchM) {
                ...
                var url="uploadSearch_editRecords.php?SearchMRN="+SearchMRN;
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <img src="personal_files/registration.gif" width="350" height="30">
...
//-->
                        ...
                        <table width="96%" align="center" cellpadding="4" cellspacing="0">
                          <tbody>
                            ...
                            <tr valign="top">
                              <td height="35" align="right" valign="middle" class="greyBgd"> Relationship<font color="red">*</font></td>
