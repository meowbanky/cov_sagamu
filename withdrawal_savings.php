...
<title>COV, SAGAMU -  Withdrwal from Savings</title>
...
function getContributionBalance(id){
	
			
		//document.getElementById('Save').style.display="none";
		
			
		var strURL="getContribution_withdrawal.php?id="+id;
		var req = getXMLHTTP();
...
function processWithdrawal(id)  {	
		...
		if (document.getElementById('txtCoopid').value.trim() == ""){
			alert("Please Search Member's ID to Process Withdrawal");
			document.getElementById('txtCoopid').focus();
			}else if((document.getElementById('Amount').value.trim() == "0")||(document.getElementById('Amount').value.trim() == "")){
				alert("Please Input Amount to Withdraw");
				document.getElementById('Amount').focus();
				}else if(document.getElementById('Amount').value == "0.00"){
				alert("Please Input Amount Greater than Zero to Withdraw");
				document.getElementById('Amount').focus();
				}else if(document.getElementById('Period').value == "na"){
				alert("Please Select Withdrawal Period");
	...
	//	var period = document.getElementById('PeriodId').value;
		if (confirm("Are you sure your want to Post Withdrawal")){
			var amount = document.getElementById('Amount').value;
			var period = document.getElementById('Period').value;
			
			var strURL="getWithdrawal.php?id="+id+"&amount="+amount+"&period="+period;
		var req = getXMLHTTP();
			...
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
					...
					if (req.status == 200) {						
						...
						alert("Withdrawal Operation Successful");
						clearBox()	;
						} else {
						alert("There was a problem while using XMLHTTP:\n" + req.statusText);
					}
...
<br>
  ...
  <tbody><tr>
    <td>Records Updated successful</td>
                        ...
                        <form action="" method="POST" name="eduEntry" onSubmit="return(validate()); ">
                         <fieldset>
                         <legend class="contentHeader1"> Withdrawal from Savings<a name="top"></a></legend>
                         <table width="66%" align="center" cellpadding="4" cellspacing="0">
                           ...
                           <td colspan="2" height="1"><img src="skills_files/spacer.gif" width="1" height="1"></td>
                             ...
                             <tr valign="top" align="left">
                               <td height="27" colspan="2" align="center" class="greyBgd"> <strong class="tableHeaderContentDarkBlue">Search Member</strong></td>
                             </tr>
                             <tr valign="top" align="left">
                               <td height="35" align="right" valign="middle" class="greyBgd">Period:</td>
                               <td align="left" valign="middle" class="greyBgd"><select name="Period" id="Period">
...
?>
                             ...
                             <tr valign="top" align="left">
                               <td width="37%" height="35" align="right" valign="middle" class="greyBgd">Name</td>
                               <td width="63%" align="left" valign="middle" class="greyBgd"><input name="name" type="text" class="innerBox" id="name" onBlur="fill();" onKeyUp="lookup(this.value);" value="" size="30" / autocomplete="off">
                             ...
                             <tr valign="top" align="left">
                               ...
                               <td class="greyBgd" valign="middle" align="left"><input name="txtCoopid" type="text" class="innerBox" id="txtCoopid" readonly onMouseOver="getContributionBalance(this.value)"></td>
                             </tr>
                             <tr valign="top" align="left">
                               <td class="greyBgd" valign="middle" align="right" height="35">Amount:</td>
                               <td class="greyBgd" valign="middle" align="left"><input name="Amount" type="text" id="Amount" onChange="this.value=number_format(this.value)" value="0.00" /></td>
                             </tr>
                             <tr valign="top" align="left">
                               <td class="greyBgd" valign="middle" align="right" height="35">Available Contribution:</td>
                               <td class="greyBgd" valign="middle" align="left"><div id="available"><input name="available" type="text" id="available" onChange="this.value=number_format(this.value)" value="0.00" /></div></td>
                             </tr>
                             <tr valign="top" align="center">
                               <td colspan="2" valign="middle" height="10"><input name="Search" type="button" class="formbutton" id="Submit" value="Withdraw" onClick="processWithdrawal(document.forms['eduEntry'].txtCoopid.value)"></td>
                             </tr>
                             <tr valign="top" align="center">
                           ...
                           <tr valign="top" align="left">
                             <td colspan="2" height="3"><img src="skills_files/spacer.gif" width="1" height="1">
                               <div id="status_old"></div> <div id="status"></div></td>
                           </tr>
