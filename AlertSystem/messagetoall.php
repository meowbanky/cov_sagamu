...
tbl_personalinfo.MobilePhone FROM tbl_personalinfo order by tbl_personalinfo.patientid Asc";
...
doSendMessage($recipients = $row_coopid2['MobilePhone'], $message = 'The Nigeria Labour Congress (NLC) has called off its nationwide strike therefore be at your duty post 2morrow Monday 23rd May 2016');
