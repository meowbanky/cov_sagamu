   ...
   <table border="0" cellspacing="0" cellpadding="2" width="993">
        ...
        <tr>
          <td class="bodyText"><p>&nbsp;</p>		  
            <table width="93%" border="1" bordercolor="#00FF33">
              <tr>
                <th width="18%" scope="col"><span class="style8">COOP ID </span></th>
                <th width="18%" scope="col"><span class="style8">SHARES</span></th>
                <th width="19%" scope="col"><span class="style8">SAVINGS</span></th>
                <th scope="col" width="15%"><span class="style8">LOAN BALANCE </span></th>
                <th width="10%" scope="col"><span class="style8">TEL. NO </span></th>
                <th width="55%" scope="col"><span class="style8">PERIOD</span></th>
              </tr>
             <?php do { ?> <tr>
                
                  <th scope="row"><span class="style5"><?php echo $row_masterTransaction['COOPID']; ?></span></th>
                  <td align="right"><span class="style5"><strong><?php echo number_format($row_masterTransaction['Shares'],2,'.',','); ?></strong></span></td>
                  <td align="right"><span class="style5"><strong><?php echo number_format($row_masterTransaction['Savings'],2,'.',','); ?></strong></span></td>
                  <td align="right"><span class="style5"><strong><?php echo number_format($row_masterTransaction['outstanding'],2,'.',','); ?></strong></span></td>
                  <td><span class="style5"><strong><?php echo $row_masterTransaction['MobileNumber']; ?></strong></span></td>
