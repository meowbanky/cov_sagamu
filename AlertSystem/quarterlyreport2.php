...
<?php do { ?>    <tr>
          ...
          <?php $item_type=null;
				$sum = 0;
                if ($item_type != $row_masterTransaction['TransactionPeriod']) {
				$item_type = $row_masterTransaction['TransactionPeriod'];
				$sum = $sum + $row_masterTransaction['savingsAmount'] ;}?>
          
         <?php if ($row_masterTransaction['TransactionPeriod'] != $row_coopid['TransactionPeriod']){ echo "
          <tr>
          <td> </td>
          <td> ". $row_masterTransaction['savingsAmount']. " </td>
          <td>&nbsp </td>
          <td>&nbsp </td>
          <td>&nbsp </td>
          <td>&nbsp;</td>
