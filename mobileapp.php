...
// Calculate the percentation
    ...
    $recipients = $row_PersonalinFo['MobilePhone'] ;//$_POST['telephone'];	
	$message = 'Please download the COV COOP android mobile App by clicking on this link http://emmaggi.com/cov/download/cov_member.apk Your username is:-'. $row_PersonalinFo ['UserID']. ' and your Password :- '. $row_PersonalinFo['PlainPassword'] .' You will be prompted to change your password on your first login. Kindly use password you can easily remember.';
