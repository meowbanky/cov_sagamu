...
$country = mysql_query($query_country, $hms) or die(mysql_error());
$row_country = mysql_fetch_assoc($country);
$totalRows_country = mysql_num_rows($country);

mysql_select_db($database_hms, $hms);
$query_tribe = "SELECT tribe.tribe FROM tribe";
$tribe = mysql_query($query_tribe, $hms) or die(mysql_error());
$row_tribe = mysql_fetch_assoc($tribe);
$totalRows_tribe = mysql_num_rows($tribe);
...
$bloodgroup = mysql_query($query_bloodgroup, $hms) or die(mysql_error());
$row_bloodgroup = mysql_fetch_assoc($bloodgroup);
$totalRows_bloodgroup = mysql_num_rows($bloodgroup);
...
function validate(){
//var cansubmit=false
if(document.eduEntry.Submit.value == "Update"){
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <td class="Content" valign="top" width="180"><p>&nbsp;</p>
    ...
    <table class="innerWhiteBox" width="96%" border="0" cellpadding="4" cellspacing="0">
      <tbody>
        <tr>
          <td class="sidenavtxt" align=""><em><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Welcome,</font></em> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><span><br>
            <img src="personal_files/spacer.gif" width="1" border="0" height="8"><img src="personal_files/arrow_bullets2.gif" border="0"> <a href="changepasswd.php">Change Password</a> <br>
            <img src="personal_files/spacer.gif" width="1" border="0" height="8"><img src="personal_files/arrow_bullets2.gif" border="0"> <a href="personal.php">Edit Details</a> <br>
            <img src="personal_files/spacer.gif" width="1" border="0" height="8"><img src="personal_files/arrow_bullets2.gif" border="0"> <a href="http://careers.mtnonline.com/logout.asp">Logout</a> </span></font></td>
        </tr>
      </tbody>
    </table>
    <br>
    ...
    <table class="innerWhiteBox" width="96%" border="0" cellpadding="4" cellspacing="0">
      <tbody>
        <tr>
          <td colspan="2" class="sidenavtxt" align=""><p><a href="mycv.php">View My CV</a><img src="personal_files/spacer.gif" width="8" height="8"> <font color="#009966">
            <?php if (($totalRows_Education > 0) && ($totalRows_rstPersonal > 0) ) {echo "<IMG alt=\"CV Completed\" align=absMiddle src=\"mycv_files\/cv_completed.gif\" width=16 height=12>" ; } else {echo "<IMG alt=\"CV Incompleted\" align=absMiddle                   src=\"mycv_files\/cv_uncompleted.gif\" width=16 height=12>" ; }?>
            </font> <br>
          </p></td>
        </tr>
        <tr valign="top">
	...
	">Personal Information </a></td>
        ...
        <tr>
          <td colspan="2" class="legend" align="">Legend<em><br>
            <img src="personal_files/cv_completed.gif" alt="CV Completed" width="9" align="absmiddle" height="8">-Complete<img src="personal_files/spacer.gif" width="8" height="8"> <font color="#009966"><img src="personal_files/cv_uncompleted.gif" alt="CV Completed" width="9" align="absmiddle" height="8"></font>-Incomplete </em></td>
        </tr>
      </tbody>
    </table>
    <br>
  ...
  <tbody><tr>
    <td>Your update was successful</td>
          ...
          <form method="POST" name="eduEntry" onsubmit="return(validate()); ">
            <p>
            <fieldset>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="greyBgd" width="43%" align="left" height="35"><div id="patcategory">
                      <select name="patCategory" class="innerBox" id="patCategory" onChange="javascript:Expand90(this)">
...
?>
                        ...
                        <?php
} while ($row_bloodgroup = mysql_fetch_assoc($bloodgroup));
  $rows = mysql_num_rows($bloodgroup);
  if($rows > 0) {
...
?>
                    ...
                    <tr valign="middle" align="left">
                      ...
                      <td class="greyBgd" width="57%" align="left"><input name="DOB" class="innerBox" id="DOB" type="text">
...
?>
                      ...
                      <?php
} while ($row_tribe = mysql_fetch_assoc($tribe));
  $rows = mysql_num_rows($tribe);
  if($rows > 0) {
...
?>
                            ...
                            <tr valign="top">
                              ...
                              <td class="greyBgd" valign="middle"><input name="NOKAddress" type="text" class="innerBox" id="NOKAddress"></td>
                            </tr>
                      ...
                      <p>
                        <input name="Submit2" onClick="location.href='mycv.php'" class="formbutton" value="Back to My CV" type="button">
                        <input name="Submit" class="formbutton" value="Update" type="submit">
                      </p></td>
                  </tr>
                  <tr valign="top" align="left">
            ...
            <div id="patoc"  name="patoc" style="display: none; margin-left: 0em;">
              <fieldset>
                ...
                <table width="96%" align="center" cellpadding="4" cellspacing="0">
                  <tbody>
                    <tr valign="top">
                      <td width="36%" height="35" align="right" valign="middle" class="greyBgd"> MR No : </td>
                      <td class="greyBgd" valign="middle" width="64%"><input name="SearchMRN" type="text" class="innerBox" id="SearchMRN"></td>
                    </tr>
                    <tr valign="top">
                      <td height="35" align="right" valign="middle" class="greyBgd"> Patient Last Name: </td>
                      <td class="greyBgd" valign="middle"><input name="SLastName" type="text" class="innerBox" id="SLastName"></td>
                    </tr>
                    <tr valign="top">
                      <td height="35" align="right" valign="middle" class="greyBgd"> Patient First Name : </td>
                      <td class="greyBgd" valign="middle"><input name="SFirstName" type="text" class="innerBox" id="SFirstName"></td>
                    </tr>
                    <tr valign="top">
                      <td height="35" align="right" valign="middle" class="greyBgd"> E-Mail: </td>
                      <td class="greyBgd" valign="middle"><input name="Semail" type="text" class="innerBox" id="Semail"></td>
                    </tr>
                    <tr valign="top">
                      <td height="35" align="right" valign="middle" class="greyBgd"> Phone No :</td>
                      <td class="greyBgd" valign="middle"><input name="SphoneNo" type="text" class="innerBox" id="SphoneNo"></td>
                    </tr>
                    <tr valign="top">
                      <td height="35" align="right" valign="middle" class="greyBgd"> Date of Birth : </td>
                      <td class="greyBgd" valign="middle"><input name="SDOb" class="innerBox" id="SDOb" type="text">
                        <input src="personal_files/ew_calendar.gif" alt="Pick a Date" onClick="popUpCalendar(this, this.form.SDOb,'yyyy-mm-dd');return false;" type="image">
                        * </td>
                    </tr>
                    <tr valign="top" align="right">
                      <td height="3" colspan="2" align="center" class="Content"><img src="workhistory_files/spacer.gif" width="1" height="1">
                        <input name="Button" class="formbutton" value="Search" type="button"></td>
                    </tr>
                  </tbody>
                </table>
              </fieldset>
