...
//	$amount = str_replace(",","",$_POST['txtAmountGranted']);
  ...
  $insertSQL = sprintf("INSERT INTO tbl_surety (surety, periodID, loanID,loanCollector) VALUES (%s, %s, %s,%s)",
                       GetSQLValueString($_POST['suretyID'], "text"),
					   GetSQLValueString($_GET['periodID'], "text"),
					    GetSQLValueString($_GET['loanid'], "text"),
						GetSQLValueString($_GET['loanCollector'], "text"));
...
mysql_select_db($database_cov, $cov);
$query_collectorInfo = sprintf("SELECT tbl_personalinfo.Lname, tbl_personalinfo.Fname, tbl_personalinfo.Mname, tbl_loan.loanamount, tbl_loan.periodid FROM tbl_loan INNER JOIN tbl_personalinfo ON tbl_personalinfo.memberid = tbl_loan.memberid WHERE loanid = %s",GetSQLValueString($loanIDs,"int"));
$collectorInfo = mysql_query($query_collectorInfo, $cov) or die(mysql_error());
$row_collectorInfo = mysql_fetch_assoc($collectorInfo);
$totalRows_collectorInfo = mysql_num_rows($collectorInfo);

mysql_select_db($database_cov, $cov);
$query_suretyInfo = sprintf("SELECT suretyid,tbl_personalinfo.Lname,tbl_personalinfo.Fname,tbl_personalinfo.Mname FROM tbl_surety
INNER JOIN tbl_personalinfo ON tbl_surety.surety = tbl_personalinfo.memberid WHERE loanid = %s",GetSQLValueString($loanIDs, "int"));
$suretyInfo = mysql_query($query_suretyInfo, $cov) or die(mysql_error());
$row_suretyInfo = mysql_fetch_assoc($suretyInfo);
$totalRows_suretyInfo = mysql_num_rows($suretyInfo);

mysql_select_db($database_cov, $cov);
$query_checkSurety = sprintf("SELECT Count(tbl_surety.surety) as checkS FROM tbl_surety WHERE tbl_surety.loanID = %s GROUP BY tbl_surety.loanID",GetSQLValueString($loanIDs, "int"));
$checkSurety = mysql_query($query_checkSurety, $cov) or die(mysql_error());
$row_checkSurety = mysql_fetch_assoc($checkSurety);
$totalRows_checkSurety = mysql_num_rows($checkSurety);
...
<title><?php echo $row_title['value']; ?>-  Add addSurety</title>
...
<script type="text/javascript">
	...
	function fill(thisValue) {
		$('#suretyID').val(thisValue);
		setTimeout("$('#suggestions').hide();", 200);
		getLoanBalance(document.getElementById('suretyID').value);
		document.eduEntry.txtAmountGranted.focus();
                         ...
                         <fieldset>
                           ...
                           <table width="97%" align="center" cellpadding="4" cellspacing="0">
                             <tbody>
                               ...
                               <tr valign="top" align="left">
                                 <td height="35" align="right" valign="middle" class="greyBgd">Name of Collection:</td>
                                 <td align="left" valign="middle" class="greyBgd"><strong><?php echo $row_collectorInfo['Lname']. '  '.$row_collectorInfo['Fname'] ; ?></strong></td>
                               </tr>
                               <tr valign="top" align="left">
                                 <td height="35" align="right" valign="middle" class="greyBgd">Amount:</td>
                                 <td align="left" valign="middle" class="greyBgd"><strong><?php echo number_format($row_collectorInfo['loanamount']); ?></strong></td>
                               </tr>
                               <tr valign="top" align="left">
                             ...
                             <div class="suggestionList" id="autoSuggestionsList" style="position: relative; top: 5px; "></div>
                               ...
                               <tr valign="top" align="left">
                                 ...
                                 <td class="greyBgd" valign="middle" align="left"><input name="suretyID" type="text" class="innerBox" id="suretyID" readonly></td>
                                 </tr>
                              
                               <tr valign="top" align="left">
                                 <td colspan="3" valign="middle" align="center" height="10"><?php if ($row_checkSurety['checkS'] < 2){?><input name="Submit2" type="submit" class="formbutton" value="Save" onClick="submith()"><?php } ?>
                                   <!-- <input name="Submit" onClick="location.href='editAccountNo.php'" class="formbutton" value="Edit Account No." type="button"></td>
                         -->
                                   </tr>
                               <tr valign="top" align="left">
                                 <td colspan="3" height="3"><p><img src="resource/spacer.gif" width="1" height="1"></p></td>
                                 </tr>
                               <tr valign="top" align="left">
                                 <td colspan="3" height="3" align="center"><strong>NAME OF SURETY</strong></td>
                               </tr>
                               <tr valign="top" align="left">
                                 <td colspan="3" height="3" align="center"><?php do { ?>
                                     <?php echo $row_suretyInfo['Lname'].' '.$row_suretyInfo['Fname'].' '.$row_suretyInfo['Mname'] ; ?> <a href="deleteSurety.php?id=<?php echo $row_suretyInfo['suretyid'] ?>">Delete</a><br>
                                     <?php } while ($row_suretyInfo = mysql_fetch_assoc($suretyInfo)); ?></td>
                               </tr>
                               </tbody>
                             </table>
                           </fieldset>
...
mysql_free_result($suretyInfo);
mysql_free_result($collectorInfo);
?>
