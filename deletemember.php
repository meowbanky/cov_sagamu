...
<title>MHWUN, OOUTH -  Delete Members </title>
...
function getDeleteMember(id)  {		
		
		if (document.getElementById('txtCoopid').value.trim() == ""){
			alert("Please Search Member's ID to Delete");
	...
	//	var period = document.getElementById('PeriodId').value;
		if (confirm("Are you sure your want to delete selected item(s) \n This note that this action is irreversible")){
		var strURL="getDeleteMember.php?id="+id;
		var req = getXMLHTTP();
  ...
  <tbody><tr>
    <td>Records Updated successful</td>
                        ...
                        <form action="<?php echo $editFormAction; ?>" method="POST" name="eduEntry" onSubmit="return(validate()); ">
                         <fieldset>
                         <legend class="contentHeader1"> Delete Member<a name="top"></a></legend>
                         <table width="66%" align="center" cellpadding="4" cellspacing="0">
                           ...
                           <td colspan="2" height="1"><img src="skills_files/spacer.gif" width="1" height="1"></td>
                             ...
                             <tr valign="top" align="left">
                               ...
                               <td width="63%" align="left" valign="middle" class="greyBgd"><input name="CoopName" type="text" class="innerBox" id="CoopName" onBlur="fill();" onKeyUp="lookup(this.value);" value="" size="30" / autocomplete="off">
                             ...
                             <tr valign="top" align="left">
                               ...
                               <td class="greyBgd" valign="middle" align="left"><input name="txtCoopid" type="text" class="innerBox" id="txtCoopid" readonly></td>
                             </tr>
                             <tr valign="top" align="center">
                               <td colspan="2" valign="middle" height="10"><input name="Search" type="button" class="formbutton" id="Submit" value="Delete" onClick="getDeleteMember(document.forms['eduEntry'].txtCoopid.value)"></td>
                             </tr>
                             <tr valign="top" align="center">
